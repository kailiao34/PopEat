...
namespace ExitGames.Demos.DemoAnimator
{
	...
	public class PlayerNameInputField : MonoBehaviour
	{
		...
		public void SetPlayerName(string value)
		{
			...
			PhotonNetwork.playerName = value +  "   所選擇的食物:" + HallManager.hallManager.food; // force a trailing space string in case value is an empty string, else playerName would not be updated.
